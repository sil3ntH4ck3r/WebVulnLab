...
<head>
    ...
    <link rel="stylesheet" href="fileuploadabuse.css">
    <title>File Upload Abuse</title>
...
<body>
    ...
    <header>
        <nav>
            <div class="container">
                ...
                <ul class="menu">
                <li><a href="http://fileuploadabuse.local/index.php#">Inicio</a></li>
                    <li><a href="http://fileuploadabuse.local/index.php#services">Servicios</a></li>
                    <li><a href="http://fileuploadabuse.local/index.php#about">Sobre Nosotros</a></li>
                    <li><a href="http://fileuploadabuse.local/index.php#contact">Contacto</a></li>
                </ul>
            </div>
        </nav>
    </header>
    ...
    <form action="upload.php" method="post" enctype="multipart/form-data" class="contact" id="contact">
        <div class="container">
            <h2>Suba su CV</h2>
            <p>Solo se aceptan archivos en formato PDF</p>
            <div class="contact-form" id="file-upload-form">
