...
// Generar un valor aleatorio para session_id
function generateRandomString($length = 5) {
    return bin2hex(random_bytes($length));
}
$sessionId = isset($_GET['session_id']) ? $_GET['session_id'] : generateRandomString(10);
...
<body>
            ...
            <div class="container">
                ...
                <ul class="menu">
                    <?php
                        ...
                        {   
                            echo '<li><a href="http://sessionpuzzling.local/index.php">Login</a></li>';
                            echo '<li><a href="http://sessionpuzzling.local/register.php">Register</a></li>';
                            echo '<li><a href="http://sessionpuzzling.local/reiniciar.php">Reiniciar Base de Datos</a></li>';
                        }
                    ?>
                    <?php
                    if ($_SESSION['loggedin']==true)
                    {   
                        echo '<li><a href="http://sessionpuzzling.local/logout.php">Logout</a></li>';
                        echo '<li><a href="http://sessionpuzzling.local/perfil.php">Perfil</a></li>';
                        echo '<li><a href="http://sessionpuzzling.local/reiniciar.php">Reiniciar Base de Datos</a></li>';
                    }
                    ?>
    ...
    <div class="login-box">
      ...
      <form id="formulario-inicio" action="verificar.php?session_id=<?php echo $sessionId; ?>" method="post">
        <div class="user-box">
