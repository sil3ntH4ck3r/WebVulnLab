		...
		<li class="nav-item"> 
		  ...
		  <?php
                ...
                <?php
                    ...
                    {
                ?>
                <li class="nav-item"> <a class="nav-link <?php if ($CURRENT_PAGE == "Logout") {?>active<?php }?>" href="http://localhost:8005/vuln/csrf.php">Cambiar Contraseña</a> </li>
                <?php 
                    }                
				?>
		</ul>
 ...
 if($submit){
     ...
     if($conn->connect_errno > 0){
        ...
        //connection successfull.
            ...
            echo "<li class=\"tick\">Conectado a la base de datos con exito.</li>";   
            ...
            if($table_comment){
                ...
                if($insert_comment){
                    echo "<li class=\"tick\">Tabla de comentarios creada con exito.</li>"; 
                }else{
            ...
            if($table_product){
                ...
                if($insert_product){
                    echo "<li class=\"tick\">Tabla de productos creado con exito.</li>"; 
                }else{
            ...
            if($table_user){
                ...
                if($insert_user){
                    echo "<li class=\"tick\">Tabla de usuarios creado con exito.</li>"; 
                }else{
