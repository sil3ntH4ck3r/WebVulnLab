            ...
            <div class="container">
                ...
                <ul class="menu">
                    <?php
                        ...
                        {   
                            echo '<li><a href="http://jwt.local/index.php">Login</a></li>';
                            echo '<li><a href="http://jwt.local/register.php">Register</a></li>';
                            echo '<li><a href="http://jwt.local/reiniciar.php">Reiniciar Base de Datos</a></li>';
                        }
                    ?>
                    <?php
                    if ($_SESSION['loggedin']==true)
                    {   
                        echo '<li><a href="http://jwt.local/logout.php">Logout</a></li>';
                        echo '<li><a href="http://jwt.local/perfil.php">Perfil</a></li>';
                        echo '<li><a href="http://jwt.local/reiniciar.php">Reiniciar Base de Datos</a></li>';
                    }
                    ?>
