<?php
    ...
    if (isset($redirect_url)){
        if (strpos($_GET['url'], "send.php") !== false){
            header("Location: " . $redirect_url);
        } else {
            http_response_code (500);
            echo "<p>Solo puedes redirigirte a send.php</p>";
            exit;
        }
    }
?>
...
<head>
    ...
    <link rel="stylesheet" href="openredirect.css">
    ...
    <header>
        <nav>
            <div class="container">
                ...
                <ul class="menu">
                <li><a href="http://openredirect.local/index.php#">Inicio</a></li>
                    <li><a href="http://openredirect.local/index.php#services">Servicios</a></li>
                    <li><a href="http://openredirect.local/index.php#about">Sobre Nosotros</a></li>
                    <li><a href="http://openredirect.local/index.php#contact">Contacto</a></li>
                </ul>
            </div>
        </nav>
    </header>
    ...
    <section class="contact" id="contact">
        <div class="container">
            ...
            <div class="contact-form">
                <form action="http://openredirect.local/index.php?url=send.php" method="post">
